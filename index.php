...
<head>
  ...
  <title>Kimlik Kartı Oluşturucu - Roswell Check</title>
...
<body>
  ...
  <div class="container">
      ...
      <div class="card-body">
        <div class="row align-items-center">
          <div class="col">
            ...
            <div class="mb-2">  <div class="yazi">Sahte Kimlik Oluşturucu</div>  </div>
          </div>
          <div class="col-auto d-none d-lg-block">
            <img src="img/tor.png" height="100">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="text-one">Görseller yüksek kaliteli değildir, bundan ötürü direkt olarak orijinal halinde kullanmanız durumunda diğer sistemler sizin sahtecilik yaptığınız farkına varabilir. Görselleri indirdikten sonra mockup yaparak kullanmanızı tavsiye ederim.</div>
        <br>
        <div class="d-inline">
            <button type="submit" class="btn btn-primary shadow" onclick="window.open('https://t.me/RoswellCheck', '_blank')">Telegram</button>
        </div>
        <div class="d-inline ml-3">
            <button type="submit" class="btn btn-primary shadow" onclick="window.open('https://t.me/AliRoswell', '_blank')">Contact</button>
            <div class="d-inline ml-3">
            <button type="submit" class="btn btn-primary shadow" onclick="window.open('donate.php')">Bağış Yap!</button>
        </div>
    </div>
    ...
    <div class="card text-white bg-primary rounded shadow mt-4">
      <div class="card-body">
        <form action="#" class="row" id="form">
          <div class="col-lg-6">
            <div>İsim:</div>
            <input class="form-control d-block mt-2 shadow" name="name" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');"
            placeholder="Kimlik üzerinde yazacak ismi girin." required>
          </div>
          <div class="col-lg-6 mt-3 mt-lg-0">
            <div>Soyisim:</div>
            <input class="form-control d-block mt-2 shadow" name="surname" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');"
          ...
          <div class="col-lg-6 mt-3">
            ...
            <input class="form-control d-block mt-2 shadow" name="tckn" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if (this.value.length > 11) this.value = this.value.slice(0, 11);"
          ...
          <div class="col-lg-6 mt-3">
            <div>Anne İsmi:</div>
            <input class="form-control d-block mt-2 shadow" name="mother_name" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');"
            placeholder="Kimlik üzerinde yazacak anne ismini girin." required>
          </div>
          <div class="col-lg-6 mt-3">
            <div>Baba Adı:</div>
            <input class="form-control d-block mt-2 shadow" name="father_name" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');"
